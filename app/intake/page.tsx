              ...
              <div className="px-6 pb-6 space-y-6 border-t border-black/5">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <input type="range" min="30" max="300" step="5" value={form.idealPrice} onChange={e => {
                      const ideal = parseInt(e.target.value);
                      set("idealPrice", ideal);
                      if (ideal >= form.maxPrice) set("maxPrice", ideal + 20);
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="range" min="50" max="500" step="10" value={form.maxPrice} onChange={e => {
                      const max = parseInt(e.target.value);
                      if (max > form.idealPrice) set("maxPrice", max);
