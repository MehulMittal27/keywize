      ...
      <main className="relative z-10 flex flex-col lg:flex-row items-center max-w-7xl mx-auto px-8 pt-12 pb-24 lg:pt-24 gap-16">
        ...
        <div className="flex-1 flex flex-col items-start gap-8 z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <Link href="/intake?mode=voice" className="w-full sm:w-auto px-8 py-4 bg-[#111111] text-white rounded-full font-medium hover:bg-gray-800 transition-all active:scale-95 shadow-xl shadow-black/10 flex items-center justify-center gap-2">
